...
class ReducedQRDecomposition {
  ...
  GenericMatrix get householderMatrix {
    ...
    _householderMatrix = new Matrix.fromFloat64List(values, _cols);
  ...
  GenericMatrix get upperTriangularFactor {
    ...
    _upperTriangularFactor = new Matrix.fromFloat64List(values, _cols);
  ...
  GenericMatrix get orthogonalFactor {
    ...
    _orthogonalFactor = new Matrix.fromFloat64List(values, _cols);
  ...
  GenericMatrix solve(GenericMatrix B) {
    ...
    return new Matrix.fromFloat64List(xVals, xCols).subMatrix(0, _cols - 1, 0, xCols - 1);
  }
}