...
class PivotingLUDecomposition {
  ...
  GenericMatrix get lowerFactor {
    ...
    _lowerFactor = new Matrix.fromFloat64List(values, _cols);
  ...
  GenericMatrix get upperFactor {
    ...
    _upperFactor = new Matrix.fromFloat64List(values, _cols);
  ...
  GenericMatrix get pivotMatrix {
    ...
    _pivotMatrix = new Matrix.fromFloat64List(values, _rows);
